...
/*@SWIG:otapi\otapi.i,386,OT_CAN_BE_CONTAINED_BY@*/
...
/*@SWIG@*/
	// ------------------------
	/*@SWIG:otapi\otapi.i,336,OT_CONTAINER_TYPE_MEMBERS@*/
	private List elementList = new ArrayList();
/*@SWIG@*/
	/*@SWIG:otapi\otapi.i,417,OT_ADD_ELEMENT@*/  // THIS BLOCK CONTAINS JAVA CODE.
