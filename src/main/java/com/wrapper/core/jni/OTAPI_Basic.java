...
public class OTAPI_Basic {
  ...
  public static String Wallet_ImportNym(String DISPLAY_NAME, String KEY_FILE_CONTENTS) {
    return otapiJNI.OTAPI_Basic_Wallet_ImportNym(DISPLAY_NAME, KEY_FILE_CONTENTS);
  }
